...
void fun1(struct Rectangle r1){
    ...
    r1.length = 20;
    cout<<"In fun1:"<< endl << "Length: "<< r1.length << endl << "Breadth: " << r1.breadth <<endl;
}
...
void fun2(struct Rectangle &r2){
    ...
    r2.length = 20;
    cout<<"In fun2:"<< endl << "Length: "<< r2.length << endl << "Breadth: " << r2.breadth <<endl;
}
...
void fun3(struct Rectangle *r3){
    ...
    cout<<"In fun3:"<< endl << "Length: "<< r3->length << endl << "Breadth: " << r3->breadth <<endl;
...
int main(){
    ...
    cout<<"Rectangle in HEAP: "<<endl<<rect->length<<endl<<rect->breadth<<endl;
